...
MIDDLEWARE = [
    'wesgarlock.base.middleware.TenantMiddleware',
...
ROOT_URLCONF = 'wesgarlock_test.urls'
...
DATABASE_USER = 'wgarlock'
DATABASE_PASSWORD = 'Su_293193938website'
...
WSGI_APPLICATION = 'wesgarlock_test.wsgi.application'

WAGTAIL_SITE_NAME = "wesgarlock"

# Base URL to use when referring to full URLs within the Wagtail admin backend -
# e.g. in notification emails. Don't include '/admin' or a trailing slash
BASE_URL = 'http://wesgarlock.com'
